...
public class MybatisMetaHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        ...
        this.strictInsertFill(metaObject, "createBy", Long.class, UserContext.getUser().getId());
        this.strictInsertFill(metaObject, "updateBy", Long.class, UserContext.getUser().getId());
    }
