...
//        String packageName = "/Users/dxm/IdeaProjects/hof/src/main/java/com/lee/hof/sys/bean/model";
//        //生成sql的文件夹
        String filePath = "/Users/dxm/IdeaProjects/hof/src/main/java/com/lee/hof/sys/bean/model";
//        //项目中实体类的路径
        String prefix = "com.lee.hof.sys.bean.model.";
        String className = "";
//
...
//        List<String> list = getAllClasses(packageName);
        ...
        List<String> list = Collections.singletonList("com.lee.hof.sys.bean.model.CourtDanceGroup");


        for (String str : list) {
//            className = prefix + str.substring(0, str.lastIndexOf("."));
            String sql = generateSql(str , filePath);
            sqls.append(sql);
        }
